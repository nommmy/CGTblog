        ...
        <div className="react-split-mde-preview welcome_content">
          ...
          <section>
            ...
            <p>
              ...
              マンガたちにスポットを当てる手助けができたらと思って、このブログをはじめました。なので、あまりにもメジャーな作品は紹介しません！（ネタが尽きたら、、）気になっている作品がある方がこのブログを読んで、実際にマンガを読んでくれたり、購入してくれたりしたら嬉しい限りです。
            </p>
            <p>
            ...
            <section>
              ...
              <div className="welcome_image">
                <img src="genre_search.png" alt="genre_search" />
              </div>
              <p>
